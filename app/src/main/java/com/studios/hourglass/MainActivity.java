...
import hourglass.studios.com.R;

import static hourglass.studios.com.R.layout.activity_main;
...
public class MainActivity extends ListActivity implements
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
            contactMessages = Class.forName("com.studios.hourglass.ContactMessages");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_compose:
                try {
                    textMessage = Class.forName("com.studios.hourglass.Message");
                } catch (ClassNotFoundException e) {
                    System.err.println(e.getMessage());
                }
